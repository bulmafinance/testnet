...
import "../vnft-core/interface/optional/IUnderlyingContainer.sol";
import "../../commons/solidity-utils/openzeppelin/token/ERC20/ERC20Upgradeable.sol";
    ...
    ReentrancyGuardUpgradeable
{
        ...
        returns (uint256 withdrawCurrencyAmount, uint256 withdrawTokenAmount)
    {
        ...
        if (
            ...
            if (
                ...
                withdrawTokenAmount = slotDetail.totalValue.div(
                    slotDetail.lowestPrice
                );
        ...
        returns (uint128)
    {
        ...
        int256 iPrice = oracle.getPriceOfMaturity(voucher, slotDetail.maturity);
        if (iPrice < 0) {
