...
import "../offering-market-core/PriceManager.sol";
    ...
    ReentrancyGuardUpgradeable
{
    ...
    function initialize(IIVOSolver solver_) public {
    ...
    function _setSolver(IIVOSolver newSolver_) public virtual onlyAdmin {
